...
if __name__=="__main__":
    ...
    for idx, row in df_0_data.iterrows():
        ...
        select_table_sql = """SELECT ID, START_IDX FROM MANAGE_PHYSICAL_TABLE2 WHERE DATA_BASIC_ID = {}  ORDER BY ID DESC""".format(data_basic_id)
        ...
        update_table_sql = """UPDATE MANAGE_PHYSICAL_TABLE2 SET TARGET_ROWS = ? """ \
                           """WHERE ID = ? """
        ...
        update_insert_sql = """UPDATE MANAGE_PHYSICAL_TABLE2 SET DATA_INSERTED_YN = 'Y' """ \
